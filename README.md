...
The Python script's plotting of Benford's law and Last Digits test on 2020 voter data saw in a few states deviations that indicate potential anomalies (fraud) affecting both parties. Overall though, a naive and very on the surface interpretation of the results indicate either that there is fraud in many areas or nothing at all.
